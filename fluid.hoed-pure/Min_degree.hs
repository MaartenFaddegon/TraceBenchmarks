...
min_degree = observe "min_degree" min_degree'
...
inter_sec :: (Ord a, Observable a) => [a] -> [a] -> Bool
inter_sec = observe "inter_sec" inter_sec'
...
rm_list :: (Ord a,Observable a) => [a] -> [a] -> [a]
rm_list = observe "rm_list" rm_list'
...
-- morge two lists
-- mg_line :: (Ord a,Observable a) => [a] -> [a] -> [a]
mg_line = observe "mg_line" mg_line'
...
-- merge many lists
-- mg_lines :: (Ord a,Observable a) => [[a]] -> [a]
mg_lines = observe "mg_lines" mg_lines'
