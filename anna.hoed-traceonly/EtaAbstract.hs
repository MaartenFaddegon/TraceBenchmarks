...
eaEtaAbstract :: AnnExpr Naam TExpr ->
                 AnnExpr Naam TExpr
eaEtaAbstract = observe "eaEtaAbstract" eaEtaAbstract'
...
eaMakeApChain = observe "eaMakeApChain" eaMakeApChain'
...
eaMakeNewArgs = observe "eaMakeNewArgs" eaMakeNewArgs'
...
eaCurry = observe "eaCurry" eaCurry'
...
eaUncurry = observe "eaUncurry" eaUncurry'
